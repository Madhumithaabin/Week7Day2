...
public class VerifyService extends LearnBaseService{

	public VerifyService(ChromeDriver driver,String chatNo) {
...
public VerifyService verifyupdate(String updatechatNumber)
{
...
public VerifyService  verifyDelete(String deleteChatNUm)
{
	WebElement frame2 = driver.findElement(By.id("gsft_main"));
	driver.switchTo().frame(frame2);
...
public VerifyService verifyConfigure(String updatechatNumber)
{
		WebElement frame2 = driver.findElement(By.id("gsft_main"));
		driver.switchTo().frame(frame2);
		driver.findElement(By.xpath("(//input[@placeholder='Search'])[2]")).sendKeys(updatechatNumber,Keys.ENTER);
